...
extern const MyFont_typedef TCVN;
extern const MyFont_typedef TCVN10Height2Width;
extern const MyFont_typedef Constantia8H1WBoldItalicUnder;
extern const MyFont_typedef TCVN10H1W_BIU;
//auto add here
